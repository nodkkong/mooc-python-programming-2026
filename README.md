...
- [x] **Part 1**: Fundamentals, variables, conditional statements
- [x] **Part 2**: Loops, execution control, and function basics
- [x] **Part 3**: String manipulation, list operations, nested loops
- [x] **Part 4**: Advanced functions, modules, and complex data structures
...
- [ ] **Part 12**: Functional Programming, Generators, `map`/`filter`
- [ ] **Part 13**: 2D Game Development with Pygame
...
- **Course**: [University of Helsinki Python MOOC](https://programming-2026.mooc.fi/)
